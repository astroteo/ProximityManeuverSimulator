...
// (in-package robosat_gazebo_ros_plugins_msgs.msg)
...
class ProximityDynamicObjectModel {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ProximityDynamicObjectModel
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ProximityDynamicObjectModel
    let len;
    let data = new ProximityDynamicObjectModel(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ProximityDynamicObjectModel(null);
...
module.exports = ProximityDynamicObjectModel;
