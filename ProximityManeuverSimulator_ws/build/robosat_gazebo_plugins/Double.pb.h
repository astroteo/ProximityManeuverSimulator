...
class Double : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:robosat_gazebo_plugins_msgs.msgs.Double) */ {
 public:
  Double();
  virtual ~Double();
  ...
  // @@protoc_insertion_point(class_scope:robosat_gazebo_plugins_msgs.msgs.Double)
 private:
